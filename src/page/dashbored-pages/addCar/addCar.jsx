...
import deletePhoto from "../../../assets/daletePhoto.svg"
    ...
    <>
      <div className="autocar w-[100%] ">
        <div className="flex justify-between items-center  mb-[40px]  ">
          ...
          <button className="delete">Add Car</button>
        </div>
        <div className="w-[100%]">
        ...
        <div className="w-[100%] flex items-center justify-center ">
          <div className="add flex items-center justify-center w-[30%] h-[180px]  cursor-pointer ">
            <input
              type="file"
              style={{ display: "none" }}
          ...
          >
            {images.map((url, index) => (
              ...
              >
                <div className="content w-[90%] h-[90%] relative">
                  <img src={url} alt={`Slide ${index}`} className="" />
                  <img src={deletePhoto} alt=" delete photo" className="absolute top-[10px] right-[10px] w-[20px]" />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
          ...
          <div className="w-[100%]">
            ...
            >
              {({ errors, touched }) => (
                <Form>
                  <div className="w-[100]">
                    <div className=" flex justify-between items-center w-[80%] mb-[20px]">
